					...
					<div class="card w-100" style="border: 0;">
						...
						@endif
							...
							<div class="py-5 text-center">
								...
								<p class="text-muted font-weight-bolder">Enter your email and password</p>
							</div>
							<div style="width: 80%;margin:0 auto;">
								...
								<form class="form" action="{{ url('login') }}" method="POST">
									...
									<div class="form-group py-3 m-0">
										<input type="text" class="form-control placeholder-dark-75 @error('email') is-invalid @enderror"  name="email" value="{{ old('email') }}" placeholder="email" autocomplete="off" />
										@error('email')
